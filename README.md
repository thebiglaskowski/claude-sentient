...
| 🧪 Tests | 875 | Profiles (242), agents (108), hooks (215), commands (81), schemas (166), integration (63) |
...
# Hook tests (215 tests) — security, I/O contracts, Agent Teams, context predictions
